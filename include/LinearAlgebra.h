...
class Matrix {
    ...
    void shape_check1(size_t m, size_t n) const;
    ...
    void set(const size_t m, const size_t n, const ild& data) {
        set(m, n, vd(data));
    }
    void set(const size_t m, const size_t n, ild&& data) noexcept {
